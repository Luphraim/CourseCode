package xmu.middleware.user.service;
...
import xmu.middleware.user.dao.UserDao;
import xmu.middleware.user.domain.User;
import xmu.middleware.user.util.CommonUtil;
import xmu.middleware.user.util.ResponseUtil;
